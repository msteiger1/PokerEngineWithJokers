...
public class Hand {
	...
	public void countJokersInHand(){
		for (eCardNo a: eCardNo.values()){
			if (CardsInHand.get(a.getCardNo()).getRank() == eRank.JOKER)
				numberOfJokers += 1;
		}
